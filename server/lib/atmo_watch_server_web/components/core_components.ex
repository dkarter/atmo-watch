defmodule AtmoWatchServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AtmoWatchServerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AtmoWatchServerWeb.Gettext, "errors", msg, opts)
    # end
